...
LDFLAGS     = -s EXPORTED_FUNCTIONS="['_malloc','_free','_ts_init','_ts_setAlgorithm','_ts_reset','_ts_setRatio','_ts_setPhaseControl','_ts_getNumNeededSamples','_ts_process']" \
...
$(OUT): $(SRC) $(SRC_DIR)/wsola.h $(SRC_DIR)/phase_vocoder.h $(SRC_DIR)/simple_fft.h $(SRC_DIR)/time_stretcher.h $(SRC_DIR)/ring_buffer.h | $(BUILD_DIR)
